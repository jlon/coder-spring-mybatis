package com.ailink.framework.redis.jedis;
...
import com.ailink.framework.utils.date.DateUtil;
...
public class RedisUtil {
	 ...
	 *         pairs.put("sex", "Female"); jedis.hmset("key", hash);
	 */
	 ...
	 * jedis.sadd(key, scoreMembers); } catch (Exception e) {
	 * pool.returnBrokenResource(jedis); e.printStackTrace(); } finally {
	...
	public static void main(String[] args) {
		...
		Date bdate=DateUtil.StringToDate("2014-01-11 20:32:32","yyyy-MM-dd HH:mm:ss");
		
		Date edate=DateUtil.StringToDate("2015-05-16 20:32:32","yyyy-MM-dd HH:mm:ss");
		
		Long min =DateUtil.Date2Time(bdate)/1000;
		System.err.println("min="+min);
		
		Long max =DateUtil.Date2Time(edate)/1000;
		System.err.println("max="+max);
		
		//String 
		Set<String>  result = new HashSet<String>();
		RedisUtil redisUtil = new RedisUtil("123.57.254.158", 6379);
		Jedis jedis = redisUtil.getJedis();
		
        System.err.println(jedis.info());
	} 
	 ...
	 * @param args
	 */
	 public static void sentinels( String[] args )  
	    {  
	        Set<String> sentinels = new HashSet<String>();  
	        sentinels.add("172.18.18.207:26379");  
	        JedisSentinelPool pool = new JedisSentinelPool("mymaster", sentinels);  
	        //pool.getResource()取得的Jedis实例会及时更新到新的主实例地址。 
	        Jedis jedis = pool.getResource();  
